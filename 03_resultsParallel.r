...
geom_point(data=worldInd[!is.na(worldInd$annee) & worldInd$annee == 2008 & worldInd$infected == 1, ], aes(X, Y), col = "red", shape = 16, size = 1)+
ggtitle("2008")
p
...
ggtitle(max(worldInd$simulAnnee, na.rm =T))
